...
r("LeftLogoItem", module="vietcuppos.uix.components.leftnav")
r("LeftNavigation", module="vietcuppos.uix.components.leftnav")
r("LeftNavigationItem", module="vietcuppos.uix.components.leftnav")
r("LeftNavigationContent", module="vietcuppos.uix.components.leftnav")
r("BottomNavigation", module="vietcuppos.uix.components.bottomnav")
r("Button_Item", module="vietcuppos.uix.components.bottomnav")
